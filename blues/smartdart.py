...
class SmartDarting(SimNCMC):
    ...
    def dartsFromPDB(self, pdb_list, forcefield, residueList=None, basis_particles=None):
        ...
        pdb_list: list of str
            List containing pdbs used to define smart darting
        forcefield: str
            Path of forcefield file
        residueList: list of ints
            List containing the ligand atom indices.
    ...
    def dartsFromMDTraj(self, system, file_list, topology=None, residueList=None, basis_particles=None):
        ...
        residueList: list of ints
            List containing the ligand atom indices. If None uses self.residueList instead.
        basis_particles: list of 3 ints
            Specifies the 3 indices of particles whose coordinates will be used
            as basis vectors. If None is specified, uses those found in basis particles.
        ...
        n_dartboard: list of 1x3 np.arrays
            Center of mass coordinates of residueList particles in new basis set.
    ...
    def dartsFromAmber(self, inpcrd_list, prmtop, residueList=None, basis_particles=None):
        ...
        Parameters
        ----------
        inpcrd_list: list of str
            List of paths corresponding to inpcrd files from which to add smart darts
        prmtop: str
            Path of prmtop file to be sued with the inpcrds from inpcrd_list
        residueList: list of ints
            List containing the ligand atom indices. If None uses self.residueList instead.
        basis_particles: list of 3 ints
            Specifies the 3 indices of particles whose coordinates will be used
