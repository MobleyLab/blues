...
from blues.models import Model_SmartDart, findNewCoord
...
class MoveProposalTester(unittest.TestCase):
    ...
    def test_smart_dart(self):
        ...
        com = self.model.getCenterOfMass(orig_pos[self.model.atom_indices], self.model.masses)
        basis_part = self.model.basis_particles
        com_new_coord = findNewCoord(orig_pos[basis_part[0]], orig_pos[basis_part[1]], orig_pos[basis_part[2]], com)
