...
def check_dependencies():
    ...
    if found_openmm:
        if not found_openmm_711_or_earlier:
            msg = [
                bar,
                '[Unmet Dependency] BLUES requires OpenMM version 7.1.1. You have version %s.' % openmm_version, bar
            ]
    else:
        msg = [
            bar,
...
setup(
    ...
    install_requires=[
        'numpy', 'cython', 'scipy', 'openmm', 'parmed', 'mdtraj', 'pandas', 'netCDF4', 'pyyaml', 'pytest'
    ],
    zip_safe=False,
